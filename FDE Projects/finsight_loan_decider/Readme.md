...
Evaluated on the held-out test set (6,515 rows). All charts generated by `eval_report.py`.

| Metric | Value |
|---|---|
| AUC-ROC | 0.989 |
| Average Precision | 0.978 |
| Precision @ threshold 0.6 | 98.3% |
| Recall @ threshold 0.6 | 80.2% |
| False Positives | 19 |
| False Negatives | 276 |
...
![Precision-Recall Curve](Reports/precision_recall.png)
...
- [x] n8n workflow — Webhook → ML Risk Scorer → High Risk? → Gmail + Slack + Google Sheets *(completed 2026-07-01)*
- [x] Model evaluation report — confusion matrix, ROC curve, feature importance, precision-recall curve *(completed 2026-07-01)*
